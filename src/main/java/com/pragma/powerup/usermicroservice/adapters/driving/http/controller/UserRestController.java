...
public class UserRestController {
    ...
    public ResponseEntity<RoleResponseDto> getRoleForUserById(@PathVariable Long userId) {
        RoleEntity roleDto = personHandler.getRoleByUserId(userId);
        return ResponseEntity.ok(roleHandler.roleEntitytoRespDto(roleDto));
    }
